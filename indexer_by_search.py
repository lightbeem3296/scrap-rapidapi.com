...
OUTPUT_FILE_PATH = CUR_PATH / "index_result.jsonl"


def search_by(page, query: str) -> None:
    search_link = (
        f"https://rapidapi.com/search?term%3D%2522{query}%2522%26sortBy%3DByRelevance"
    )
    page.goto(search_link, wait_until="networkidle")
